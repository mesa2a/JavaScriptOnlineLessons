...
// TODO: demonstrateScope関数を実装してください
// ローカル変数を定義し、内部関数から外側の変数にアクセスする
const demonstrateScope = null; // ここを修正してください
...
// 2. クロージャの基本
// ========================================
// TODO: makeCounter関数を実装してください
// プライベート変数countを持ち、呼び出すたびにインクリメントする関数を返す
const makeCounter = null; // ここを修正してください
...
// 3. カウンターのデモ
// ========================================
// TODO: createCounter関数を実装してください
// increment, decrement, getCountメソッドを持つオブジェクトを返す
const createCounter = null; // ここを修正してください
...
// 4. 関数ファクトリー
// ========================================
// TODO: makeAdder関数を実装してください
// xを受け取り、yを加算する関数を返す
const makeAdder = null; // ここを修正してください

// TODO: makeMultiplier関数を実装してください
// multiplierを受け取り、numberを乗算する関数を返す
const makeMultiplier = null; // ここを修正してください
...
// 5. プライベート変数
// ========================================
// TODO: createPerson関数を実装してください
// プライベート変数ageを持ち、getName, getAge, birthdayメソッドを返す
const createPerson = null; // ここを修正してください
...
// 6. 銀行口座のデモ
// ========================================
// TODO: createBankAccount関数を実装してください
// プライベート変数balanceを持ち、deposit, withdraw, getBalanceメソッドを返す
const createBankAccount = null; // ここを修正してください
...
// 7. タスク管理のデモ
// ========================================
// TODO: createTaskManager関数を実装してください
// プライベート配列tasksを持ち、addTask, completeTask, getTasksメソッドを返す
const createTaskManager = null; // ここを修正してください
